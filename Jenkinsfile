pipeline {
    ...
    post {  
         ...
         failure {  
             mail bcc: '', body: "<b>test</b><br>Project:mr-maven ${env.JOB_NAME} <br>Build Number: ${env.BUILD_NUMBER} <br> URL de build: ${env.BUILD_URL}", cc: '', charset: 'UTF-8', from: '', mimeType: 'text/html', replyTo: '', subject: "ERROR CI: Project name -> ${env.JOB_NAME}", to: "mahfuzurrahm518@gmail.com";  
         }  
         unstable {  
